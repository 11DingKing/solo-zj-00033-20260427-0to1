...
CREATE INDEX idx_snippets_likes_count ON snippets(likes_count DESC);
CREATE INDEX idx_snippets_parent_id ON snippets(parent_id);
CREATE INDEX idx_snippet_files_snippet_id ON snippet_files(snippet_id);
CREATE INDEX idx_snippet_files_version_id ON snippet_files(version_id);
